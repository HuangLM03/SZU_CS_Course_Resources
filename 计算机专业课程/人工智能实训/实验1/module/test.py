...
class Inference(nn.Module):
    ...
    def runForWeb(self, image):
        ...
        for i in range(pyr_down_times):
            result_image = cv2.pyrUp(np.array(result_image))
...
def functionForGradio(image):
    ...
    result_image = model.runForWeb(image)
    return result_image
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Configure')
    # specify your data path here!
    parser.add_argument('--img_path', type=str, default="C:/Users/黄亮铭/Desktop/大学课程/计算机视觉/实验1/测试图像/office_1.jpg")
    parser.add_argument('--output', type=str, default="C:/Users/黄亮铭/Desktop/大学课程/计算机视觉/实验1/")
    # ratio are recommended to be 3-5, bigger ratio will lead to over-exposure
    parser.add_argument('--ratio', type=int, default=5)
    # model path
    parser.add_argument('--Decom_model_low_path', type=str, default="./ckpt/init_low.pth")
